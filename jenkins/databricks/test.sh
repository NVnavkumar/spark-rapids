...
if [ -d "$LOCAL_JAR_PATH" ]; then
    ...
    if [[ $TEST_MODE == "ALL" || $TEST_MODE == "IT_ONLY" ]]; then
        ...
        bash /home/ubuntu/spark-rapids/integration_tests/run_pyspark_from_build.sh --runtime_env="databricks" --test_type=$TEST_TYPE -k test_ts_write_fails_datetime_exception
